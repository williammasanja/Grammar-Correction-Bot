...
def word_lookup(list):
    ...
    print("{} word(s) found in the wordbase. {} word(s) not found".format(word_count+1, len(wrong_words)))
    #print(wrong_words)
...
#seperate(text)
#print(seperate_text)
#new_text = ' '.join(x for x in word_lookup(seperate_text))
